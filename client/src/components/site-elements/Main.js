            ...
            <div className="col-12 ml-sm-auto col-md-9 ml-md-auto ml-lg-auto mr-auto" id="mainBodySection">
                <div className="row">
                    <div className="col-12 col-sm-6 ml-sm-auto col-md-6 ml-md-auto col-lg-6 ml-lg-auto">
                        <img src={profilePic} className='img-fluid' id='aboutMePhoto' alt={profilePic} name='profilePhoto'/>
                    </div>

                    <div className="col-12 col-sm-6 mr-sm-auto col-md-6 mr-md-auto col-lg-6 mr-lg-auto" id="aboutMeText" name='aboutMeParagraphs'>
                        <p name='paraOne'>
                        ...
                        <p>
                            <b>I currently work as a QA Specialist for a software company specializing
                            in content management software for life science companies.</b>
                        </p>
                    </div>
                </div>
            </div>
