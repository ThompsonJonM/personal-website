      ...
      >
        <div className="row">
          <div className="col-12 ml-sm-auto ml-md-auto ml-lg-auto">
            <h5 className="text-center" name="messageNote">
              <strong>Feel free to leave me a message!</strong>
            </h5>
          </div>
        </div>
        ...
        <form className="col-12 ml-auto mr-auto" onSubmit={this.handleSubmit}>
          <div className="row formRow">
            <div className="col-12 col-md-6 ml-auto mr-auto form-group">
              <label className="h5" name="nameTag">
                {" "}
                Name{" "}
              </label>
              <input
            ...
            <div className="col-12 col-md-6 ml-auto mr-auto form-group">
              <label className="h5" name="emailTag">
                {" "}
                E-Mail{" "}
              </label>
              <input
            ...
            <div className="col-12 ml-auto mr-auto form-group">
              <label className="h5" name="messageTag">
                {" "}
                Message{" "}
              </label>
              <textarea
            ...
            <input
              type="submit"
              value="Submit"
              className="col-4 ml-auto mr-auto btn btn-dark"
              name="submitButton"
            />
          </div>
        </form>
